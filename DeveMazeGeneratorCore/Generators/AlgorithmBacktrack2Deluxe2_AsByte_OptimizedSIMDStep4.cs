...
{
    public class AlgorithmBacktrack2Deluxe2_AsByte_OptimizedSIMDStep4 : IAlgorithm<Maze>
    {
        ...
        {
            // Pack bounds results into SIMD vector
            ...
            // Check map positions (unfortunately can't be fully vectorized due to map access pattern)
